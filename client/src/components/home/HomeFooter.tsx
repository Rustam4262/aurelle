...
export function HomeFooter() {
    ...
    return (
        <footer className="bg-card/50 backdrop-blur-sm border-t border-border pt-20 pb-10" data-testid="section-footer">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
                    ...
                    <div className="md:col-span-2 md:col-start-7">
                        ...
                        <ul className="space-y-4">
                            ...
                            <li>
                                <Link href="/auth" className="text-muted-foreground hover:text-primary transition-colors font-light">
                                    {t("marketplace.footer.myBookings")}
                                </Link>
                            </li>
                            <li>
                                <Link href="/about" className="text-muted-foreground hover:text-primary transition-colors font-light">
                                    {t("about.title")}
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div className="md:col-span-2">
                        ...
                        <ul className="space-y-4">
                            <li>
                                <Link href="/owner" className="text-muted-foreground hover:text-primary transition-colors font-light">
