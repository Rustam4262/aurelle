        ...
        <Link href={`/salon/${salon.id}`}>
            ...
            >
                ...
                <div className="p-5">
                    ...
                    {description && (
                        <p className="text-muted-foreground text-sm line-clamp-2 mb-4 h-10 leading-relaxed font-light">{description}</p>
                    )}
            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex items-center justify-between gap-6 flex-wrap mb-12">
                    ...
                    {salons.length > 0 && (
                        <div className="flex items-center gap-3 animate-in fade-in slide-in-from-right duration-700">
                            <Button variant="outline" size="sm" className="rounded-full px-5 h-10 border-border/60 hover:border-primary/50" data-testid="button-sort-rating">
                ...
                {salons.length > 0 ? (
                    ...
                    <Card className="p-16 text-center border-dashed border-2 border-border/50 bg-muted/20 rounded-3xl animate-in zoom-in duration-500">
                        ...
                        <Link href="/owner">
                            <Button className="rounded-full px-8 h-12 shadow-lg shadow-primary/10 hover:shadow-primary/20 transition-all font-medium" data-testid="button-register-salon-empty">
