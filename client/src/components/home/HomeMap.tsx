        ...
        <section className="py-20 bg-muted/30" data-testid="section-map">
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-12 animate-in fade-in slide-in-from-top duration-700">
                    <h2 className="font-serif text-3xl md:text-4xl text-foreground mb-3 font-light">{t("marketplace.map.title")}</h2>
                    <p className="text-muted-foreground text-lg font-light">{t("marketplace.map.subtitle")}</p>
                </div>
                        ...
                        {mapError && (
                            <div className="absolute inset-0 flex items-center justify-center bg-muted/80 backdrop-blur-md z-10">
                                <div className="text-center p-10 max-w-md bg-white rounded-3xl shadow-xl">
                                    ...
                                    <p className="text-foreground font-semibold text-xl mb-3">Ошибка загрузки карты</p>
                                    <p className="text-sm text-muted-foreground leading-relaxed font-light">{t("marketplace.map.apiNote")}</p>
