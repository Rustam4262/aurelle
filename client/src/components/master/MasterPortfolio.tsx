...
export function MasterPortfolioTab({ masterId, masterName, portfolio, isLoading, onRefresh }: MasterPortfolioTabProps) {
        ...
        <div className="space-y-6">
            ...
            <Card className="p-6">
                ...
                {isLoading ? (
                    ...
                    <p className="text-center text-muted-foreground py-8">{t("marketplace.master.noPortfolio")}</p>
                )}
            </Card>
        </div>
    );
