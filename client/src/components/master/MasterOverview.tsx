        ...
        {[
          {
            ...
            value: `${stats?.totalEarnings?.toLocaleString() || "0"} UZS`,
            label: "totalEarnings",
          },
          {
            icon: Calendar,
            ...
            label: "upcomingAppointments",
          },
          {
            icon: Star,
            color: "text-amber-500",
            value: master.averageRating || "0.0",
            label: "rating",
          },
          ...
          <Card
            key={idx}
            className="p-6 text-center transition-all hover:shadow-md hover:scale-[1.02] duration-300"
          >
