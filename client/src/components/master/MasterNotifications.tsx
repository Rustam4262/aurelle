                ...
                <div className="max-h-80 overflow-y-auto">
                    {notifications && notifications.length > 0 ? (
                        notifications.slice(0, 10).map((notification) => (
                            <div
                                key={notification.id}
                                className={`px-4 py-3 border-b last:border-b-0 cursor-pointer hover:bg-muted/50 ${!notification.isRead ? "bg-muted/30" : ""
                                    }`}
                                onClick={() => {
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-xs text-muted-foreground mt-0.5 line-clamp-2">
                                            {(() => {
                                                ...
                                                return notification.message || t("marketplace.notifications.newBookingFallback");
                                            })()}
                                        </p>
