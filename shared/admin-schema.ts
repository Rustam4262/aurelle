...
export const sanctionReasonCodes = pgTable(
  ...
  (table) => [index("idx_sanction_reason_codes_code").on(table.code)],
);
...
export const chatTemplates = pgTable(
  ...
  (table) => [index("idx_chat_templates_category").on(table.category)],
);
